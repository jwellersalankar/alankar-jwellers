    ...
    const rate =
      item.type === "Gold"
        ? item?.purity === "18k"
          ...
          : item?.purity === "22k"
            ? ((data.shopDetails?.goldRatePer10g ?? 0) / 10) * 0.916
  ...
  return (
    <div className="min-h-screen  flex flex-col items-center gap-6">
      ...
      <div
        ref={printRef}
        id="invoice-print"
        className="w-[794px] mx-auto p-6 relative overflow-hidden"
        ...
        <div className="relative z-10">
          <div className="flex items-start justify-between mb-3">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <div
                  className="w-[82x] h-[72px] flex items-center justify-center flex-shrink-0"
                  // style={{
                ...
                <img
                  ...
                  alt=""
                  className="h-15 w-20 mt-4 object-cover"
                />
              </div>
              <div>
                <p
                ...
                >
                  {data?.shopDetails?.name || "ALANKAR JEWELLERS"}
                </p>
                {/* <p
                style={{
                  fontFamily: "'Georgia', serif",
                ...
                <tr key={index} className="hover:bg-[#FAF6F1]/60">
                  ...
                  <TD className="text-right">
                    {item.type === "Gold"
                      ...
                      : item.type === "Silver"
                        ? (item?.purity === "18k"
                            ? ((data.shopDetails?.silverRatePerKg ?? 0) /
                                1000) *
                              0.75
                            : item?.purity === "22k"
                              ? ((data.shopDetails?.silverRatePerKg ?? 0) /
                        ...
                        : ((item.price ?? 0) / item.weight).toLocaleString(
                            "en-IN",
                          )}
                  </TD>
                  <TD className="text-right">
            ...
            <div className="w-[240px] flex-shrink-0 border border-[#8B6914]/40">
              {[
                ...
                { label: "Total Tax Amt", value: fmt(totalTax), bold: true },
                {
                  ...
                  value: `${fmt(totalDiscount)}(${data?.discount}%)`,
                },
                {
                  label: "Invoice Value",
                  value: fmt(invoiceValue),
                  bold: false,
                },
                {
                  label: "Grand Total",
